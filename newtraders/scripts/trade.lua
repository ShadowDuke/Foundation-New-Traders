...
newtraders:register({
    ...
    SellingResourceList={
		...
		{ ResourceMaxAmount = { Resource = "MEAL", Quantity = 50 }, ReplenishingAmount = 20, UnitPrice = { Resource = "GOLD_COINS", Quantity = 60 } },
	},
    Allegiance = "LABOUR"
})
...
newtraders:register({
    ...
    BuyingResourceList = {
		{ ResourceMaxAmount = { Resource = "WOOD", Quantity = 50 }, ReplenishingAmount = 50, UnitPrice = { Resource = "STONE", Quantity = 1 } },
		{ ResourceMaxAmount = { Resource = "WHEAT", Quantity = 50 }, ReplenishingAmount = 50, UnitPrice = { Resource = "WOOL", Quantity = 2 } },
		{ ResourceMaxAmount = { Resource = "RESOURCE_FEED", Quantity = 50 }, ReplenishingAmount = 50, UnitPrice = { Resource = "RESOURCE_DUNG", Quantity = 1 } },		
	},
    SellingResourceList={
		{ ResourceMaxAmount = { Resource = "WOOD", Quantity = 50 }, ReplenishingAmount = 50, UnitPrice = { Resource = "STONE", Quantity = 1 } },
		{ ResourceMaxAmount = { Resource = "WHEAT", Quantity = 50 }, ReplenishingAmount = 50, UnitPrice = { Resource = "WOOL", Quantity = 2 } },
